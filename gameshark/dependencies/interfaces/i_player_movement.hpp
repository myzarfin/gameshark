...
public:
	...
	void run_command( c_base_entity *player, c_usercmd *cmd, player_move_helper *helper ) {
		typedef void( __thiscall *o_run_command )( void *, c_base_entity *, c_usercmd *, player_move_helper * );
		return utilities::call_virtual<o_run_command>( this, 19 )( this, player, cmd, helper );
	}

	void setup_move( c_base_entity *player, c_usercmd *cmd, player_move_helper *helper, void *data ) {
		typedef void( __thiscall *o_setup_move )( void *, c_base_entity *, c_usercmd *, player_move_helper *, void * );
		return utilities::call_virtual<o_setup_move>( this, 20 )( this, player, cmd, helper, data );
	}

	void finish_move( c_base_entity *player, c_usercmd *cmd, void *data ) {
		typedef void( __thiscall *o_finish_move )( void *, c_base_entity *, c_usercmd *, void * );
