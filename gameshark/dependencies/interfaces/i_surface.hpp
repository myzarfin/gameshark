...
public:
	...
	void set_drawing_color(Color col) {
		using original_fn = void(__thiscall*)(i_surface*, int, int, int, int);
		return (*(original_fn**)this)[15](this, col.r, col.g, col.b, col.a);
	}
	...
	void set_text_color(Color col) {
		using original_fn = void(__thiscall*)(i_surface*, int, int, int, int);
		return (*(original_fn**)this)[25](this, col.r, col.g, col.b, col.a);
	}
	...
	void draw_outlined_rect(int x, int y, int w, int h) {
		using original_fn = void(__thiscall*)(i_surface*, int, int, int, int);
		return (*(original_fn * *)this)[18](this, x, y, w, h);
	}
