...
public:
	...
	void* operator new(std::size_t nAllocSize)
	{
		...
		return CallVFunc<void*>(pKeyValuesSystem, 1, nAllocSize);
	}
	...
	void operator delete(void* pMemory)
	{
		...
		CallVFunc<void>(pKeyValuesSystem, 2, pMemory);
	}
	...
	void Init(const char* szKeyName)
	{
		...
		static auto oInitKeyValues = (InitKeyValuesFn)(utilities::pattern_scan("client.dll", ("55 8B EC 51 33 C0 C7 45"))); // @xref: "OldParticleSystem_Destroy"
	...
	void LoadFromBuffer(char const* szResourceName, const char* szBuffer, void* szFileSystem = nullptr, const char* szPathID = nullptr, void* pfnEvaluateSymbolProc = nullptr)
	{
		...
		static auto oLoadFromBuffer = (LoadFromBufferFn)(utilities::pattern_scan("client.dll", ("55 8B EC 83 E4 F8 83 EC 34 53 8B 5D 0C 89"))); // @xref: "KeyValues::LoadFromBuffer(%s%s%s): Begin"
	...
	CKeyValues* FindKey(const char* szKeyName, bool bCreate)
	{
		...
		static auto oFindKey = (FindKeyFn)(utilities::pattern_scan("client.dll", ("55 8B EC 83 EC 1C 53 8B D9 85 DB")));
	...
	void SetString(const char* szKeyName, const char* szValue)
	{
		...
		static auto oSetString = (SetStringFn)(utilities::pattern_scan("client.dll", ("55 8B EC A1 ? ? ? ? 53 56 57 8B F9 8B 08 8B 01")));
...
public:
	...
	{
		using fn = i_material*(__thiscall*)(i_material_system*, const char*, CKeyValues*);
