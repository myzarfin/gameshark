...
class c_anim_state {
public:
	void Create(c_base_entity* pEntity)
	{
		using CreateAnimationStateFn = void(__thiscall*)(void*, c_base_entity*);
		static auto oCreateAnimationState = (CreateAnimationStateFn)(utilities::pattern_scan("client.dll", ("55 8B EC 56 8B F1 B9 ? ? ? ? C7 46"))); // @xref: "ggprogressive_player_levelup"
	...
	void Update(vec3_t angView)
	{
		...
		static auto oUpdateAnimationState = (UpdateAnimationStateFn)(utilities::pattern_scan("client.dll", ("55 8B EC 83 E4 F8 83 EC 18 56 57 8B F9 F3 0F 11 54 24"))); // @xref: "%s_aim"
	...
	void Reset()
	{
		...
		static auto oResetAnimationState = (ResetAnimationStateFn)(utilities::pattern_scan("client.dll", ("56 6A 01 68 ? ? ? ? 8B F1"))); // @xref: "player_spawn"
	...
	vec3_t		vecOrigin; // 0xB8
	vec3_t		vecLastOrigin;// 0xC4
